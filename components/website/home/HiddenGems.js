                        ...
                        <div className="swiper home9-destination-slider">
                            <div className="swiper-wrapper">
                                ...
                                <div className="swiper-slide">
                                    <div className="destination-card2 five">
                                        <a href="destination-details.html" className="destination-img">
                                            <img src="assets/img/home9/destination-img3.jpg" alt=""/>
                                        </a>
                                        <div className="destination-content">
                                ...
                                <div className="swiper-slide">
                                    <div className="destination-card2 five">
                                        <a href="destination-details.html" className="destination-img">
                                            <img src="assets/img/home9/destination-img2.jpg" alt=""/>
                                        </a>
                                        <div className="destination-content">
                                ...
                                <div className="swiper-slide">
                                    <div className="destination-card2 five">
                                        <a href="destination-details.html" className="destination-img">
                                            <img src="assets/img/home9/destination-img8.jpg" alt=""/>
                                        </a>
                                        <div className="destination-content">
                                ...
                                <div className="swiper-slide">
                                    <div className="destination-card2 five">
                                        <a href="destination-details.html" className="destination-img">
                                            <img src="assets/img/home9/destination-img6.jpg" alt=""/>
                                        </a>
                                        <div className="destination-content">
                                ...
                                <div className="swiper-slide">
                                    <div className="destination-card2 five">
                                        <a href="destination-details.html" className="destination-img">
                                            <img src="assets/img/home9/destination-img7.jpg" alt=""/>
                                        </a>
                                        <div className="destination-content">
                                ...
                                <div className="swiper-slide">
                                    <div className="destination-card2 five">
                                        <a href="destination-details.html" className="destination-img">
                                            <img src="assets/img/home9/destination-img5.jpg" alt=""/>
                                        </a>
                                        <div className="destination-content">
                                ...
                                <div className="swiper-slide">
                                    <div className="destination-card2 five">
                                        <a href="destination-details.html" className="destination-img">
                                            <img src="assets/img/home9/destination-img4.jpg" alt=""/>
                                        </a>
                                        <div className="destination-content">
