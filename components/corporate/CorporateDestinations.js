        ...
        >
          {destinations.map((item, index) => (
            <SwiperSlide key={index}>
              ...
              >
                <img src={item.image} alt={item.title} className="w-100 h-100 object-fit-cover package-img" />
                <div
                ...
                >
                  <span className="badge bg-white text-dark text-2xs rounded-pill align-self-start shadow-sm fw-semibold">{item.tag}</span>
                  <div>
