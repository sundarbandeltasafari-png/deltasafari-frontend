        ...
        <>
            <div className="card h-100 border-0 shadow-sm bg-white rounded-4 overflow-hidden position-relative hover-lift transition-all">
                ...
                <div className="card-body p-3.5 d-flex flex-column justify-content-between">
                    <div>
                        <h3 className="h6 mb-1.5 text-dark text-truncate-2" style={{ minHeight: '38px', lineHeight: '1.35', fontFamily: "'Poppins', sans-serif", fontSize: '15px' }}>
                        ...
                        {isAgent && (
                            <div className="p-2 rounded-3 bg-primary-subtle border border-primary-subtle mb-2 text-start">
                                <div className="d-flex align-items-center justify-content-between">
                                    <span className="text-2xs text-primary text-uppercase" style={{ fontWeight: 500 }}>
                                        <i className="fa-solid fa-hand-holding-dollar me-1"></i> Agent Commission
                                    </span>
                                    <span className="badge bg-primary text-white px-2 py-0.5" style={{ fontSize: '11px', backgroundColor: '#0066cc', fontWeight: 500 }}>
                    ...
                    <div className="d-flex align-items-end justify-content-between pt-2.5 border-top mt-2">
                        <div>
                            ...
                            <div className="d-flex align-items-baseline gap-2">
                                ...
                                <span className="mb-0 text-nowrap package-price" style={{ fontSize: '18px', fontWeight: 700, color: isAgent ? '#0066cc' : '#0066cc' }}>
                        ...
                        {isAgent ? (
                            <button 
                                type="button" 
                                className="btn btn-primary py-1.5 px-3 text-xs rounded-pill shadow-xs d-flex align-items-center gap-1"
                                style={{ backgroundColor: '#0066cc', borderColor: '#0066cc', fontWeight: 500 }}
